...
import 'package:secure_storage_explore/services/flutter_keychain_service.dart';

import 'services/pinenacl_service.dart';

class FlutterKeychainPage extends StatefulWidget {
  const FlutterKeychainPage({Key? key}) : super(key: key);

  @override
  _FlutterKeychainPageState createState() => _FlutterKeychainPageState();
}

class _FlutterKeychainPageState extends State<FlutterKeychainPage> {
  List benchmarkValue = [];
  String data = '';
  Uint8List? encrypt;
  ...
  Future<void Function()?>? read() async {
    ...
    String privateKey = await FlutterKeychainService().read('keySaddam');
